(() => {
	const gen = 4;
	const GAME_KEYS = ["heartgold-national", "soulsilver-national"];
	...
	const BASE_DEX = [
		...
		{
			id: 172, natiId: 172, name: "Pichu", img: ({ gameKey }) => baseSprite(gameKey, 172), imgS: ({ gameKey }) => shinySprite(gameKey, 172), tags: ["other"], forms: [
