  ...
  `;
	...
	`;
		...
		games.forEach((g) => {
			...
			const imgPath = _assetPath(`game-icons/${g.key}.png`);
...
function renderMonInfoIndexPage(store, els) {
	...
	for (const mon of mons) {
		...
		const img = _assetPath(`sprites/pokemon_home/base-front/${p4}.png`);
...
async function renderMonInfoPage(store, els) {
		...
		<div class="page">
			<div class="moninfo-header">
				<div class="moninfo-header-left">
					<img class="moninfo-hero-img" src=_assetPath("sprites/pokemon_home/base-front/${pad4(natiId)}.png") alt="#${natiId}">
					<div>
	...
	(function wirePrevNext() {
		...
		function setBtn(btn, entry, dir) {
			...
			const sprite = _assetPath(`sprites/pokemon_home/menu_sprites/${pad4(id)}.png`); // menu_sprites
