...
export function DexModalResponsive() {
  return (
        ...
        <header className="dex-modal-header">
          ...
          <div className="dex-header-actions">
            <div className="dex-bulk-split" id="dexBulkSplit">
              <button id="dexSelectAll" className="button dex-bulk-primary" type="button">
                Set All to <span id="dexBulkActionLabel">Caught</span>
              </button>
              <button
