...
(() => {
	...
	const TASKS_BY_SECTION = {
		"catching": [
			...
			},
			{
				id: 3, text: "Obtain all In-Game Gift Pokémon", children: [
					...
					{ id: 2, text: "Happiny Egg", img: ({ gameKey }) => baseSprite(gameKey, 440) },
					{ id: 3, text: "Eevee", img: ({ gameKey }) => baseSprite(gameKey, 133) },
					{ id: 4, text: "Riolu", img: ({ gameKey }) => baseSprite(gameKey, 447) },
				],
			},
			{
		...
		"battle": [
			{
				id: 1, text: "Defeat Tower Tycoon Palmer in Single Battles", children: [
					{ id: 1, text: "After 21st Battle", },
					{ id: 2, text: "After 49st Battle", },
				],
			},
			{
				id: 2, text: "Defeat Tower Tycoon Palmer in Double Battles", children: [
					{ id: 1, text: "After 21st Battle", },
					{ id: 2, text: "After 49st Battle", },
				],
			},
