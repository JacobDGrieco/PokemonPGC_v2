		...
		"catching": [
			{
				id: 1, text: "Catch all the Legendaries", children: [
					{ id: 1, text: "Catch/Trade Kyogre", img: ({ gameKey }) => baseSprite(gameKey, 382), },
					{ id: 2, text: "Catch/Trade Groudon", img: ({ gameKey }) => baseSprite(gameKey, 383), },
					...
					{ id: 7, text: "Catch/Trade Latias", img: ({ gameKey }) => baseSprite(gameKey, 380), },
					{ id: 8, text: "Catch/Trade Latios", img: ({ gameKey }) => baseSprite(gameKey, 381), },
				],
			},
			{
