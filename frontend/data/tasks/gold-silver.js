		...
		"catching": [
			{
				id: 1, text: "Catch all the Legendaries", children: [
					...
					{ id: 4, text: "Catch/Trade Lugia", img: ({ gameKey }) => baseSprite(gameKey, 249), },
					{ id: 5, text: "Catch/Trade Ho-Oh", img: ({ gameKey }) => baseSprite(gameKey, 250), },
				],
			},
			{
			...
			},
			{
				id: 3, text: "Obtain all In-Game Gift Pokémon", children: [
					{ id: 1, text: "Spearow", img: ({ gameKey }) => baseSprite(gameKey, 21) },
					{ id: 2, text: "Eevee", img: ({ gameKey }) => baseSprite(gameKey, 133) },
					{ id: 3, text: "Togepi", img: ({ gameKey }) => baseSprite(gameKey, 175) },
					{ id: 4, text: "Shuckle", img: ({ gameKey }) => baseSprite(gameKey, 213) },
					{ id: 5, text: "Tyrogue", img: ({ gameKey }) => baseSprite(gameKey, 236) },
				],
			},
			{
