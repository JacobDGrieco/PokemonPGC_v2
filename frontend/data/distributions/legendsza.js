...
defineDistributionsMany(GAME_KEYS, (gameKey) => [
	...
	//   "start-date": "2025-10-16",
	//   "end-date": "2026-02-28",
	//   ball: { name: "Poké Ball", img: () => _assetPath("balls/gen9/legendsza/pokeball.png") },
	//   ribbons: [{ name: "Classic Ribbon", img: () => _assetPath("ribbons/classic.png") }],
	//   img: () => _assetPath("sprites/gen9/legendsza/base-icons/280.png"),
	// 	 shiny: true,
	//   level: 6,
	//   ot: "",
	//   tid: "",
