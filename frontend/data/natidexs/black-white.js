...
(() => {
	const gen = 5;
	const GAME_KEYS = ["black-national", "white-national"];
	...
	const BASE_DEX = [
		...
		{ id: 641, natiId: 641, name: "Tornadus", img: ({ gameKey }) => baseSprite(gameKey, 641), imgS: ({ gameKey }) => shinySprite(gameKey, 641), maxStatus: "caught", tags: ["legendary"], },
		{ id: 642, natiId: 642, name: "Thundurus", img: ({ gameKey }) => baseSprite(gameKey, 642), imgS: ({ gameKey }) => shinySprite(gameKey, 642), maxStatus: "caught", tags: ["legendary"], },
		...
		{ id: 645, natiId: 645, name: "Landorus", img: ({ gameKey }) => baseSprite(gameKey, 645), imgS: ({ gameKey }) => shinySprite(gameKey, 645), tags: ["legendary"], },
		{ id: 646, natiId: 646, name: "Kyurem", img: ({ gameKey }) => baseSprite(gameKey, 646), imgS: ({ gameKey }) => shinySprite(gameKey, 646), tags: ["legendary"], },
		{ id: 647, natiId: 647, name: "Keldeo", img: ({ gameKey }) => baseSprite(gameKey, 647), imgS: ({ gameKey }) => shinySprite(gameKey, 647), maxStatus: "caught", tags: ["mythical"], },
