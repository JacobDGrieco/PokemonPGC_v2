...
(() => {
	const gen = 6;
	const GAME_KEYS = ["x-national", "y-national"];
	...
	const BASE_DEX = [
		...
		{ id: 531, natiId: 531, name: "Audino", img: ({ gameKey }) => baseSprite(gameKey, 531), imgS: ({ gameKey }) => shinySprite(gameKey, 531), },
		...
		{ id: 719, natiId: 719, name: "Diancie", img: ({ gameKey }) => baseSprite(gameKey, 719), imgS: ({ gameKey }) => shinySprite(gameKey, 719), maxStatus: "caught", tags: ["mythical"], },
		{
