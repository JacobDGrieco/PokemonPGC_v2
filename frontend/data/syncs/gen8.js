...
const GAME_KEYS1 = ["sword", "shield"];
const GAME_KEYS2 = ["swordioa", "shieldioa"];
const GAME_KEYS3 = ["swordct", "shieldct"];

defineSyncsMany(GAME_KEYS1, ({ taskSync, eitherTaskSync, regionalSync, regionalSyncCross }) => [
...
defineSyncsMany(GAME_KEYS2, ({ taskSync, eitherTaskSync, regionalSync, regionalSyncCross }) => [
...
defineSyncsMany(GAME_KEYS3, ({ taskSync, eitherTaskSync, regionalSync, regionalSyncCross }) => [
