...
const GAME_KEYS1 = ["sun", "moon"];
const GAME_KEYS2 = ["ultrasun", "ultramoon"];

defineSyncsMany(GAME_KEYS1, ({ taskSync, eitherTaskSync, alolaSync, melemeleSync, akalaSync, ulaulaSync, poniSync }) => [
...
defineSyncsMany(GAME_KEYS2, ({ taskSync, eitherTaskSync, alolaSync, melemeleSync, akalaSync, ulaulaSync, poniSync }) => [
