...
(() => {
	...
	const DESKTOP_LAYOUT = {
		...
		"mabels-research": [
			[P(1), P(11), P(21), P(31), P(41)],
			[P(2), P(12), P(22), P(32), P(42)],
			[P(3), P(13), P(23), P(33), P(43)],
			[P(4), P(14), P(24), P(34), P(44)],
			[P(5), P(15), P(25), P(35), P(45)],
			[P(6), P(16), P(26), P(36), P(46)],
			[P(7), P(17), P(27), P(37), P(47)],
			[P(8), P(18), P(28), P(38), P(48)],
			[P(9), P(19), P(29), P(39), P(49)],
			[P(10), P(20), P(30), P(40), spacer],
		],
		"activities": [
			[P(1)]
		],
		...
		"mega-stones": [
			...
			[P(61), P(62), spacer, spacer, spacer, spacer],
		],
		"thms": [
			[P(1), P(2), P(3), P(4), P(5)],
